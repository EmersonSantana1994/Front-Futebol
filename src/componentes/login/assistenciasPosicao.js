...
export default function AssitenciasPosicao() {
    ...
    useEffect(() => {
        ...
        async function buscarTodos(e) {
            setAviso(true)
            await apiC.post("listar/assistencias_posicao", {
            })
                .then(response => {
    ...
    return (
        ...
        <>
            <Button className="btn-filtro-arquivo" onClick={(e) => navigate('/assistencia')}>
